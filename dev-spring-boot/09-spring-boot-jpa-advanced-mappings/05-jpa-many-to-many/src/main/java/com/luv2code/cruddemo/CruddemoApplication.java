...
public class CruddemoApplication {
    ...
    private void addMoreCoursesForStudent(AppDAO appDAO) {
        ...
        // create more courses
        Course tempCourse1 = new Course("Data Structures - Introduction to Data Structures");
        Course tempCourse2 = new Course("Operating Systems - Introduction to Kernel");
    ...
    private void createCourseAndStudents(AppDAO appDAO) {
        ...
        // create a course
        Course tempCourse = new Course("Data Mining - Intro to Data!");

        // create the students
        Student tempStudent1 = new Student("John", "Doe", "john@luv2code.com");
        Student tempStudent2 = new Student("Bruce", "Wayne", "bruce@luv2code.com");
